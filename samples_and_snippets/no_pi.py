...
#      """Displays values for a given set of fields as a simple GUI window. Use .show() to displ
#      ay the window; use .update() to update the values displayed.
#      """
#
#      DISPLAY_INIT = '– – –'
...
#          """Creates a Windowed (tkinter) display to replace sense_hat display. To show the
#          display (blocking) call .show() on the returned object.
#
#          Parameters
#          ----------
#          title : str
...
#          """Update the values displayed in the GUI. Expects a dictionary with keys matching the
#          field names passed to the constructor."""
...
#      # TODO: Run each of these classes in a separate terminal. You should see the CarParkDis
#       play update when you click the buttons in the CarDetector.
